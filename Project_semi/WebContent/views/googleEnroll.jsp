	...
	<div id="container">
		...
		<div id="content">
			...
			<div id="content2">
				...
				<form action="/googleEnroll" method="post">
					
					

					
					<!-- 소셜 정보랑 우리사이트 필요정보랑 합쳐야되니까 hidden으로 네개 가져옴. -->
					<input type="hidden" name="memberId" value="${google.memberId }">
					<input type="hidden" name="memberPwd" value="${google.memberId }">
					<input type="hidden" name="memberName" value="${google.memberName }">
